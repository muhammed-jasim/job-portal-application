...
class Jobs(models.Model):
    ...
    location = models.CharField(choices=JOB_LOCATION, max_length=30, null=True, default='calicut')
    categories = models.CharField(choices=CATEGORY_TYPE, max_length=30, null=True, default='marketing')
    job_type = models.CharField(choices=JOB_TYPES, max_length=30, null=True, default='full_time')
